...
public class Locations implements Serializable {
    ...
    private model.entities.Countries countryId;
    ...
    public model.entities.Countries getCountryId() {
        return countryId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof model.entities.Locations)) {
            return false;
        }
        model.entities.Locations other = (model.entities.Locations) object;
    ...
    public String toString() {
        return "com.beto.project.hazelcast.jpa.com.beto.project.hazelcast.jpa.model.Locations[ locationId=" + locationId + " ]";
    }
