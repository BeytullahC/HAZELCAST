...
public class Departments implements Serializable {
    ...
    private model.entities.Locations locationId;
    ...
    public model.entities.Locations getLocationId() {
        return locationId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof model.entities.Departments)) {
            return false;
        }
        model.entities.Departments other = (model.entities.Departments) object;
    ...
    public String toString() {
        return "com.beto.project.hazelcast.jpa.com.beto.project.hazelcast.jpa.model.Departments[ departmentId=" + departmentId + " ]";
    }
